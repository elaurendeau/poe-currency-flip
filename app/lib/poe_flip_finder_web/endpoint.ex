defmodule PoeFlipFinderWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :poe_flip_finder
  ...
  @session_options [
    store: :cookie,
    key: "_poe_flip_finder_key",
    signing_salt: "fefrtxtB",
    same_site: "Lax"
  ]
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :poe_flip_finder
  end
