...
TARGET="$REPO_ROOT/backend/src/main/resources/reference-data/item-icons-catalog.json"
...
echo "Next: run the backend test suite (especially GggItemIconGatewayTest), review the git diff, then commit if it looks right."
